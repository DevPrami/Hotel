    ...
    <div>
      <form>
        <Title
          ...
          font="outfit"
          title="Add Room"
          subTitle="Fill in the details carefully and accutarte room 
        details , pricing, amenities , to enhance the user booking experience."
        />

        {/* upload area for imgaes */}
        <p className="text-gray-800 mt-10 text-3xl">Images</p>
        ...
        <div className="w-full flex max-sm:flex-col sm:gap-4 mt-4">
          <div className="flex-1 max-w-48">
            <p className="text-gary-800 mt-4"> Room Type</p>
            <select
